...
// Reduced at low zooms to avoid heavy visual at far-out zoom levels.
...
export default function MapView({ events, headerCollapsed = false }) {
  ...
  function addLayers(map, data, sat) {
    ...
    // Safe zone outline — thinner, internal-facing (positive line-offset = inward for CCW polygons),
    // hidden in 3D and Real3D modes (zcta-safezone-extrusion is sole renderer)
    map.addLayer({
