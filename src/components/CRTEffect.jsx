...
/**
 * CRTEffect - Cinematic High-Fidelity Version
 * Designed to sit behind the map but in front of the base background.
 */
export default function CRTEffect({ active = true, limitMobile = false }) {
  ...
  return (
    /* Note: zIndex is set to 1. In MapView, ensure your map container 
       has a higher zIndex (like 10) and a transparent background.
    */
    <div 
    ...
    >
      ...
      {/* 4. CHROMA FRINGE (Color bleed at edges) */}
      <div className="absolute inset-0" style={{
